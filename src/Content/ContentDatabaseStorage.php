 ...
 */
class ContentDatabaseStorage implements ContentStorageInterface {
  ...
  /**
   * Implements Drupal\content_sync\Content\ContentStorageInterfacev::rename().
   *
   * @throws PDOException
   */
  ...
  /**
   * Implements Drupal\content_sync\Content\ContentStorageInterface::decode().
   *
